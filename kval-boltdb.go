...
// Connect should first be used to open a connection to a bbolt db with a given
// name. Returns a KVAL Bolt structure with the details required for future
// KVAL bbolt operations.
...
// Attach enables you to open the database on your own terms and then connect
// it to the KVAL binding to work on it separately. WARNING: if you do open
// the database in ReadOnly mode, then expect undefined behavior when you
...
// Disconnect lets us disconnect from a bbolt db. It is recommended that this
...
// Query is our primary function once we've opened a bbolt connection.
// Given a KVALBolt Structure, and a KVAL query string
// this function will do all of the work for you when interacting with
// bbolt. Everything should become less programmatic making for cleaner code.
...
// KVAL-BBolt/KVAL proposes a standard encoding for this data inside Key-Value
